...
class CI_Jquery extends CI_Javascript {
	 ...
	 * @return	string
	 */
        function _datepicker($element = 'this', $js = '', $ret_false = TRUE)
	{
		if ( ! is_array($js))
		{
			$js = array($js);
		}
		return $this->_add_datepicke_event($element, $js, 'datepicker');
	}
	...
	function _add_event($element, $js, $event)
	{
        ...
        function _add_datepicke_event($element, $js, $event)
	{
		if (is_array($js))
		{
			$js = implode("\n\t\t", $js);
